...
class CategoryColorController extends Controller
{
    ...
    {
        return view('admin.dashboard.category_color.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.dashboard.category_color.view', compact('color'));
    }
    ...
    {
        return view('admin.dashboard.category_color.edit', compact('categoryColor'));
    }
