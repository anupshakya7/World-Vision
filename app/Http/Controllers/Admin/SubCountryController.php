...
class SubCountryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard.subcountry.index', compact('subCountries'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.dashboard.subcountry.create', compact('countries'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.dashboard.subcountry.view', compact('subcountry'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.dashboard.subcountry.edit', compact('countries', 'subcountry'));
    }
