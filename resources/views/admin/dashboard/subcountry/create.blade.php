...
@section('title','Sub Country Create')
@section('content')
<style>
    .error {
        color: red;
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">{{ 'Create Sub Country'}}</li>
                            </ol>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header border-bottom-dashed">
                            <h5 class="card-title mb-0">{{ 'Add Sub Country' }}</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('admin.sub-country.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
