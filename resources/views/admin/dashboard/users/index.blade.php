                                ...
                                <table id="buttons-datatables"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.users.roles',$user)}}" class="btn btn-sm btn-primary">Roles</a>
                                                <a href="{{route('admin.permissions.index')}}" class="btn btn-sm btn-danger">Permissions</a>
                                            </td>
                                            <td>
