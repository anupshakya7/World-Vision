                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('admin.ati.country.update',$country) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12" style="margin-top:20px;">
                                                ...
                                                <input type="text" class="form-control" id="latitude" name="latitude"
                                                    value="{{ old('latitude',$country->latitude) }}" placeholder="Latitude">
                                            ...
                                            <div class="col-12" style="margin-top:30px;">
                                                ...
                                                <input type="text" class="form-control" id="longitude" name="longitude"
                                                    value="{{ old('longitude',$country->longitude) }}" placeholder="Longitude">
                                ...
                                <div class="col-12" style="margin-top:30px;">
                                    <a class="btn btn-info" href="{{route('admin.ati.country.index')}}">
