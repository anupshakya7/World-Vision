                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('admin.ati.indicator.update',$indicator) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <select class="form-control form-select" id="domain_id"
                                                    ...
                                                    <option value="{{ $domain->id }}" {{$indicator->domain_id == $domain->id ? 'selected':''}}>{{ $domain->variablename }}</option>
                                                    @endforeach
                                                </select>
